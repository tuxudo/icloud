<div class="col-lg-4 col-md-6">
    <div class="panel panel-default" id="icloud_back_to_my_mac-widget">
        <div id="icloud_back_to_my_mac-widget" class="panel-heading" data-container="body">
            <h3 class="panel-title"><i class="fa fa-arrow-circle-left"></i> 
                <span data-i18n="icloud.back_to_my_mac_enabled"></span>
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/icloud/get_back_to_my_mac', function( data ) {
        if(data.error){
            //alert(data.error);
            return;
        }

        var panel = $('#icloud_back_to_my_mac-widget div.panel-body'),
