<div class="col-lg-4 col-md-6">
    <div class="panel panel-default" id="icloud_home-widget">
        <div id="icloud_home-widget" class="panel-heading" data-container="body">
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/icloud/get_home', function( data ) {
        if(data.error){
            //alert(data.error);
            return;
        }

        var panel = $('#icloud_home-widget div.panel-body'),
