<div class="col-lg-4 col-md-6">
    <div class="card" id="icloud_contacts-widget">
        <div id="icloud_contacts-widget" class="card-heading" data-container="body">
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/icloud/get_contacts', function( data ) {
        ...
        var panel = $('#icloud_contacts-widget div.card-body'),
