<div class="col-lg-4 col-md-6">
    <div class="panel panel-default" id="icloud_contacts-widget">
        <div id="icloud_contacts-widget" class="panel-heading" data-container="body">
            <h3 class="panel-title"><i class="fa fa-address-book "></i> 
                <span data-i18n="icloud.contacts_icloud"></span>
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/icloud/get_contacts', function( data ) {
        if(data.error){
            //alert(data.error);
            return;
        }

        var panel = $('#icloud_contacts-widget div.panel-body'),
