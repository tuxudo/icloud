<div class="col-lg-4 col-md-6">
    <div class="panel panel-default" id="icloud_clouddesktop_desktop-widget">
        <div id="icloud_clouddesktop_desktop-widget" class="panel-heading" data-container="body">
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/icloud/get_clouddesktop_desktop', function( data ) {
        if(data.error){
            //alert(data.error);
            return;
        }

        var panel = $('#icloud_clouddesktop_desktop-widget div.panel-body'),
