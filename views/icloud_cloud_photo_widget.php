<div class="col-lg-4 col-md-6">
    <div class="panel panel-default" id="icloud_cloud_photo-widget">
        <div id="icloud_cloud_photo-widget" class="panel-heading" data-container="body">
            <h3 class="panel-title"><i class="fa fa-picture-o"></i> 
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/icloud/get_cloud_photo', function( data ) {
        ...
        var panel = $('#icloud_cloud_photo-widget div.panel-body'),
