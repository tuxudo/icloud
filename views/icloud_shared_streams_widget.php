<div class="col-lg-4 col-md-6">
    <div class="panel panel-default" id="icloud_shared_streams-widget">
        <div id="icloud_shared_streams-widget" class="panel-heading" data-container="body">
            <h3 class="panel-title"><i class="fa fa-share-square "></i> 
                <span data-i18n="icloud.shared_streams_enabled"></span>
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/icloud/get_shared_streams', function( data ) {
        if(data.error){
            //alert(data.error);
            return;
        }

        var panel = $('#icloud_shared_streams-widget div.panel-body'),
