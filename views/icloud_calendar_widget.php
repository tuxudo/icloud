<div class="col-lg-4 col-md-6">
    <div class="panel panel-default" id="icloud_calendar-widget">
        <div id="icloud_calendar-widget" class="panel-heading" data-container="body">
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/icloud/get_calendar', function( data ) {
        ...
        var panel = $('#icloud_calendar-widget div.panel-body'),
