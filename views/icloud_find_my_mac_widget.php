<div class="col-lg-4 col-md-6">
    <div class="panel panel-default" id="icloud_find_my_mac-widget">
        <div id="icloud_find_my_mac-widget" class="panel-heading" data-container="body">
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/icloud/get_find_my_mac', function( data ) {
        if(data.error){
            //alert(data.error);
            return;
        }

        var panel = $('#icloud_find_my_mac-widget div.panel-body'),
