<div class="col-lg-4 col-md-6">
    <div class="panel panel-default" id="icloud_reminders-widget">
        <div id="icloud_reminders-widget" class="panel-heading" data-container="body">
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/icloud/get_reminders', function( data ) {
        ...
        var panel = $('#icloud_reminders-widget div.panel-body'),
