<div class="col-lg-4 col-md-6">
    <div class="panel panel-default" id="icloud_stocks-widget">
        <div id="icloud_stocks-widget" class="panel-heading" data-container="body">
            <h3 class="panel-title"><i class="fa fa-line-chart"></i> 
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/icloud/get_stocks', function( data ) {
        ...
        var panel = $('#icloud_stocks-widget div.panel-body'),
