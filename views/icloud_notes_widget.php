<div class="col-lg-4 col-md-6">
    <div class="panel panel-default" id="icloud_notes-widget">
        <div id="icloud_notes-widget" class="panel-heading" data-container="body">
            <h3 class="panel-title"><i class="fa fa-sticky-note-o"></i> 
                <span data-i18n="icloud.notes_widget"></span>
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/icloud/get_notes', function( data ) {
        if(data.error){
            //alert(data.error);
            return;
        }

        var panel = $('#icloud_notes-widget div.panel-body'),
