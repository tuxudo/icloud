<div class="col-lg-4 col-md-6">
    <div class="panel panel-default" id="icloud_news-widget">
        <div id="icloud_news-widget" class="panel-heading" data-container="body">
            <h3 class="panel-title"><i class="fa fa-newspaper-o"></i> 
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/icloud/get_news', function( data ) {
        ...
        var panel = $('#icloud_news-widget div.panel-body'),
