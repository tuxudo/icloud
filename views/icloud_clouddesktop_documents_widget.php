<div class="col-lg-4 col-md-6">
    <div class="panel panel-default" id="icloud_clouddesktop_documents-widget">
        <div id="icloud_clouddesktop_documents-widget" class="panel-heading" data-container="body">
            <h3 class="panel-title"><i class="fa fa-file-o"></i> 
                <span data-i18n="icloud.clouddesktop_documents_enabled"></span>
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/icloud/get_clouddesktop_documents', function( data ) {
        if(data.error){
            //alert(data.error);
            return;
        }

        var panel = $('#icloud_clouddesktop_documents-widget div.panel-body'),
